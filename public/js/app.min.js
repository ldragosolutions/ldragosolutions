let i = 0;
let welcomeText = "Welcome to LDrago Solutions";
let speed = 50;
...
const typeWriter = () => {
    if (i < welcomeText.length) {
        document.getElementById("welcomeTxt").innerHTML += welcomeText.charAt(i);
        i++;
...
document.addEventListener("DOMContentLoaded", function() {
        ...
        function e(e, t) { if (e) { "string" == typeof e ? e = document.querySelectorAll(e) : e.tagName && (e = [e]); for (var n = 0; n < e.length; n++)(" " + e[n].className + " ").indexOf(" " + t + " ") < 0 && (e[n].className += " " + t) } }

        function t(e, t) { if (e) { "string" == typeof e ? e = document.querySelectorAll(e) : e.tagName && (e = [e]); for (var n = new RegExp("(^| )" + t + "($| )", "g"), o = 0; o < e.length; o++) e[o].className = e[o].className.replace(n, " ") } }
        if (window.onresize = function(e) { window.pageYOffset || document.documentElement.scrollTop }, "querySelector" in document && "addEventListener" in window && Array.prototype.forEach) {
            ...
            [].forEach.call(n, function(o) {
                o.addEventListener("click", function(e) {
                    ...
                    t && function(e, t) {
                        ...
                        var s = setInterval(function() { window.scrollBy(0, i), n() }, 16)
                    }(t, n || 700)
                }, !1)
            })
        }
        if (window.addEventListener("scroll", function() {
                document.body.contains(document.getElementById("navConverter")) && ((window.pageYOffset || document.documentElement.scrollTop) > function(e) { for (var t = 0, n = 0; e && !isNaN(e.offsetLeft) && !isNaN(e.offsetTop);) t += e.offsetLeft - e.scrollLeft, n += e.offsetTop - e.scrollTop, e = e.offsetParent; return { top: n, left: t } }(document.getElementById("navConverter")).top - 60 ? t(document.querySelector(".navbar"), "navbar--extended") : e(document.querySelector(".navbar"), "navbar--extended"));
            ...
            responsiveNav(".nav__mobile", { animate: !0, transition: 284, label: "Menu", insert: "before", customToggle: "toggle", openPos: "relative", navClass: "nav__mobile" })
    ...
    function(e) {
        ...
        return function i(s, a, c) {
            function l(n, e) {
                if (!a[n]) {
                    if (!s[n]) { var t = "function" == typeof require && require; if (!e && t) return t(n, !0); if (f) return f(n, !0); var o = new Error("Cannot find module '" + n + "'"); throw o.code = "MODULE_NOT_FOUND", o }
                    var r = a[n] = { exports: {} };
                    s[n][0].call(r.exports, function(e) { var t = s[n][1][e]; return l(t || e) }, r, r.exports, i, s, a, c)
                }
                return a[n].exports
            }
            ...
            4: [function(e, t, n) {
                t.exports = function(t) {
                    if (0 < t.mainSpace) {
                        var n = t.children.reduce(function(e, t) { return e + t.flexGrow }, 0);
                        0 < n && (t.children.forEach(function(e) { e.mainAround += e.flexGrow / n * t.mainSpace }), t.main = t.children.reduce(function(e, t) { return e + t.mainAround }, 0), t.mainSpace = 0)
                    }
                }
            }, {}],
            5: [function(e, t, n) {
                t.exports = function(t) {
                    if (t.mainSpace < 0) {
                        var n = t.children.reduce(function(e, t) { return e + t.flexShrink }, 0);
                        0 < n && (t.children.forEach(function(e) { e.mainAround += e.flexShrink / n * t.mainSpace }), t.main = t.children.reduce(function(e, t) { return e + t.mainAround }, 0), t.mainSpace = 0)
                    }
                }
            }, {}],
            6: [function(e, t, n) {
            ...
            9: [function(e, t, n) { t.exports = function(o) { o.children.forEach(function(e) { var t = 0; "auto" === e.crossBefore && ++t, "auto" === e.crossAfter && ++t; var n = o.cross - e.crossAround; "auto" === e.crossBefore && (e.crossBefore = n / t, e.crossAround += e.crossBefore), "auto" === e.crossAfter && (e.crossAfter = n / t, e.crossAround += e.crossAfter) }) } }, {}],
            10: [function(e, t, n) {
                t.exports = function(t) {
                    var n = 0;
                    t.children.forEach(function(e) { "auto" === e.mainBefore && ++n, "auto" === e.mainAfter && ++n }), 0 < n && (t.children.forEach(function(e) { "auto" === e.mainBefore && (e.mainBefore = t.mainSpace / n, e.mainAround += e.mainBefore), "auto" === e.mainAfter && (e.mainAfter = t.mainSpace / n, e.mainAround += e.mainAfter) }), t.mainSpace = 0)
                }
            }, {}],
            11: [function(e, t, n) { t.exports = function(e) { e.children.sort(function(e, t) { return e.order - t.order || e.index - t.index }) } }, {}],
            12: [function(e, t, n) {
                t.exports = function(e, t, n) {
                    var o = Object.assign(t, { alignContent: "stretch", alignItems: "stretch", alignSelf: "auto", display: "inline", flexBasis: "auto", flexDirection: "row", flexGrow: 0, flexShrink: 1, flexWrap: "nowrap", justifyContent: "flex-start", height: "auto", marginTop: 0, marginRight: 0, marginLeft: 0, marginBottom: 0, maxHeight: "none", maxWidth: "none", minHeight: 0, minWidth: 0, order: 0, position: "static", width: "auto" });
                    ...
                    for (var r, i = (e.getAttribute("data-style") || "") + ";" + (e.getAttribute("data-flex") || ""), s = /([^\s:;]+)\s*:\s*([^;]+?)\s*(;|$)/g; r = s.exec(i);) {
                        var a = r[1].toLowerCase().replace(/-[a-z]/g, function(e) { return e.slice(1).toUpperCase() });
    ...
    function(g, v, x) {
        ...
        var e = function(e, t) {
            ...
            var r, i, n, o, s, a, c = function(t, n, o, r) {
                ...
                p = function(e, t) {
                    var n;
                    for (n in this.options = { animate: !0, transition: 284, label: "Menu", insert: "before", customToggle: "", closeOnNavClick: !1, openPos: "relative", navClass: "nav-collapse", navActiveClass: "js-nav-active", jsClass: "js", init: function() {}, open: function() {}, close: function() {} }, t) this.options[n] = t[n];
                    ...
                    this.wrapper.inner = function(e) { if (e.children.length < 1) throw new Error("The Nav container has no containing elements"); for (var t = [], n = 0; n < e.children.length; n++) 1 === e.children[n].nodeType && t.push(e.children[n]); return t }(this.wrapper), i = this.options, r = this.wrapper, this._init(this)
                };
            return p.prototype = {
                ...
                toggle: function() {!0 === o && (a ? this.close() : this.open()) },
                open: function() { a || (d(r, "closed"), u(r, "opened"), u(h, i.navActiveClass), u(n, "active"), r.style.position = i.openPos, f(r, { "aria-hidden": "false" }), a = !0, i.open()) },
                close: function() { a && (u(r, "closed"), d(r, "opened"), d(h, i.navActiveClass), d(n, "active"), f(r, { "aria-hidden": "true" }), i.animate ? (o = !1, setTimeout(function() { r.style.position = "absolute", o = !0 }, i.transition + 10)) : r.style.position = "absolute", a = !1, i.close()) },
                resize: function() { "none" !== v.getComputedStyle(n, null).getPropertyValue("display") ? (s = !0, f(n, { "aria-hidden": "false" }), r.className.match(/(^|\s)closed(\s|$)/) && (f(r, { "aria-hidden": "true" }), r.style.position = "absolute"), this._createStyles(), this._calcHeight()) : (s = !1, f(n, { "aria-hidden": "true" }), f(r, { "aria-hidden": "false" }), r.style.position = i.openPos, this._removeStyles()) },
                ...
                _init: function() {
                    ...
                    var e = this;
                    setTimeout(function() { e.resize() }, 20), c(v, "resize", this, !1), c(v, "focus", this, !1), c(g.body, "touchmove", this, !1), c(n, "touchstart", this, !1), c(n, "touchend", this, !1), c(n, "mouseup", this, !1), c(n, "keyup", this, !1), c(n, "click", this, !1), i.init()
                },
                _createStyles: function() { m.parentNode || (m.type = "text/css", g.getElementsByTagName("head")[0].appendChild(m)) },
                _removeStyles: function() { m.parentNode && m.parentNode.removeChild(m) },
                _createToggle: function() {
                    if (i.customToggle) {
                        ...
                        t.innerHTML = i.label, f(t, { href: "#", class: "nav-toggle" }), "after" === i.insert ? r.parentNode.insertBefore(t, r.nextSibling) : r.parentNode.insertBefore(t, r), n = t
                    }
                },
                _closeOnNavClick: function() {
                    if (i.closeOnNavClick) {
                        var n = r.getElementsByTagName("a"),
                            o = this;
                        ! function(e, t, n) { for (var o = 0; o < e.length; o++) t.call(n, o, e[o]) }(n, function(e, t) { c(n[e], "click", function() { s && o.toggle() }, !1) })
                    }
                },
                ...
                _onTouchStart: function(e) { Event.prototype.stopImmediatePropagation || this._preventDefault(e), this.startX = e.touches[0].clientX, this.startY = e.touches[0].clientY, this.touchHasMoved = !1, l(n, "mouseup", this, !1) },
                ...
                _onKeyUp: function(e) { 13 === (e || v.event).keyCode && this.toggle() },
